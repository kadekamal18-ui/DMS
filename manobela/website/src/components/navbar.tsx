...
const githubUrl =
  process.env.NEXT_PUBLIC_GITHUB_URL || 'https://github.com/popcorn-prophets/Suraksha Drive AI';
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          <Link href="/" className="flex items-center space-x-2 cursor-pointer">
            <span className="font-bold text-xl tracking-tighter">TeamNano</span>
          </Link>
        </div>
        ...
        <div className="hidden xl:flex items-center space-x-1">
          <Button asChild className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 shadow-lg shadow-cyan-500/20">
            <Link href="/download" className="flex gap-2 text-sm font-semibold">
            ...
            <div className="flex flex-col h-full">
              ...
              <SheetHeader className="space-y-0 p-4 pb-2 border-b">
                <div className="flex items-center gap-2">
                  ...
                  <SheetTitle className="text-lg font-semibold">Suraksha Drive AI</SheetTitle>
