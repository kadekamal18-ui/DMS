...
const testimonials: Testimonial[] = [
  {
    ...
    quote: 'Suraksha Drive AI helps me stay focused during long shifts. The alerts are clear and timely.',
  },
  {
    name: 'Mia',
    role: 'Fleet Manager',
    ...
    quote:
      'We started using Suraksha Drive AI for safety monitoring. It’s easy to deploy and works on any phone.',
  },
  {
    name: 'Noah',
