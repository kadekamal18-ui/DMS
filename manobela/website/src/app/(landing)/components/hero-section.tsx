      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mb-4 text-4xl font-extrabold tracking-tight sm:text-6xl lg:text-7xl">
            ...
            <br />
            Powered by Suraksha Drive AI AI
          </h1>

          {/* Subheading */}
          <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground sm:text-xl font-medium">
            Suraksha Drive AI is your futuristic AI co-pilot. Our next-gen monitoring system detects 
            fatigue, distraction, and aggression in real-time, instantly saving lives with just a smartphone camera.
          </p>
