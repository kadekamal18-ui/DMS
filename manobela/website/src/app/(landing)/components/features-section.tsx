      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center mb-16">
          ...
          <p className="text-muted-foreground text-base">
            Suraksha Drive AI monitors driver behavior instantly, alerts unsafe actions immediately, works on
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-8 xl:gap-16 mb-24">
          ...
          <Image
            src="/feature-1.png"
            alt="Suraksha Drive AI Feature 1"
            width={800}
            height={800}
            sizes="100vw"
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-8 xl:gap-16">
          ...
          <div className="space-y-6 order-2 lg:order-1">
            ...
            <p className="text-muted-foreground text-base text-pretty">
              Beyond real-time monitoring, Suraksha Drive AI helps drivers analyze past sessions, navigate
          ...
          <Image
            src="/feature-2.png"
            alt="Suraksha Drive AI Feature 2"
            width={800}
            height={800}
            sizes="100vw"
