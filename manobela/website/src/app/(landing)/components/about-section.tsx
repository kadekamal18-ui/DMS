    ...
    <section id="about" className="py-24 sm:py-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl text-center mb-16">
          <h2 className="text-4xl font-extrabold tracking-tight sm:text-5xl mb-6 bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent">
            The Suraksha Drive AI Vision
          </h2>
          <p className="text-xl text-muted-foreground mb-8 font-light italic">
            Suraksha Drive AI isn't just an app; it's the future of intelligent road safety. 
            We've built a world-class AI system that watches your back so you can focus on the journey.
          </p>
        </div>
