...
const plan = {
  ...
  description: 'Full access to Suraksha Drive AI at no cost while we build and improve the system.',
  features: [
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Suraksha Drive AI is currently available at no cost for everyone. Use it freely as we continue to
            improve the system.
          </p>
        </div>
