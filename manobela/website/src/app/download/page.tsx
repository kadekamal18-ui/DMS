...
export const metadata: Metadata = {
  title: 'Download Suraksha Drive AI',
  description: 'Download the latest Suraksha Drive AI mobile app.',
...
async function fetchLatestRelease(): Promise<ReleaseInfo> {
  try {
    const res = await fetch(
      'https://api.github.com/repos/popcorn-prophets/Suraksha Drive AI/releases/latest',
    ...
    return {
      ...
      apkUrl:
        ...
        'https://github.com/popcorn-prophets/Suraksha Drive AI/releases/latest',
      apkSize: null,
    };
  }
}
...
export default async function DownloadPage() {
  ...
  const googlePlayUrl =
    ...
    'https://play.google.com/store/apps/details?id=com.Suraksha Drive AI.app';
      ...
      <main className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <section className="text-center">
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Download Suraksha Drive AI</h1>
